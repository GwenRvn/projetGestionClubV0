        ...
        <div class="row">
            <div class="col-md-3">
                <div class="view overlay hm-white-light z-depth-1-half">
                    <img src="{{asset('img/logo-diademe.png')}}" class="imgfluid" alt="" style="margin-top: 2rem;">
                </div>
                <br>
            </div>
            <!--Main information-->
            <div class="col-md-9">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris ultricies euismod arcu. Aliquam
                    ...
                    vitae, sodales eget nibh. Nulla dignissim
                    sodales quam, id placerat eros porttitor nec. Proin molestie eros vel tortor tempus, sit amet
                    placerat est pharetra. Vivamus a congue nibh, at lacinia
                    libero. Nullam tristique posuere eugiat.</p>
                <p>Nam fermentum eget lectus commodo luctus. Pellentesque ornare pellentesque justo eget suscipit. Nam
                    ...
                    vulputate mi. Phasellus tortor tortor, tempor quis metus
                    et, efficitur congue dui. Suspendisse ac
                    leo eros. Praesent lobortis diam nunc, eget tincidunt ipsum
                    laoreet eget. Proin ut sapien sed neque
